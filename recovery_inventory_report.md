...
*   **Separação Conceitual (SRP documental):** O arquivo [docs/AGENTS.md](./docs/AGENTS.md) está íntegro na pasta `/docs`, mantendo sua responsabilidade voltada a programadores humanos. No entanto, o `AGENT.md` na raiz (bootstrap) está órfão de suas conexões normativas.
