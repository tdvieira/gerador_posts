...
4.  **Decisões Arquiteturais (ADRs):** Os arquivos de ADRs ([tech-decisions.md](./.agents/memory/tech-decisions.md) e [DECISIONS.md](../../docs/DECISIONS.md)) documentam exclusivamente o racional de engenharia das decisões de design tomadas no código e infraestrutura.
