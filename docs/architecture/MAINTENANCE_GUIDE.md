...
5.  **Referências:** Siga o procedimento exaustivo mapeado no manual [RELEASE_PROCESS.md](../releases/RELEASE_PROCESS.md).
...
*   **[RELEASE_PROCESS.md](../releases/RELEASE_PROCESS.md):** Fluxo exaustivo de empacotamento e publicação Git.
