...
A presente auditoria avaliou de forma minuciosa os documentos de governança localizados na raiz do repositório do plugin ([README.md](../../README.md), [README_EN.md](../../README_EN.md), [CHANGELOG.md](../../CHANGELOG.md), [CONTRIBUTING.md](../../CONTRIBUTING.md), [SECURITY.md](../../SECURITY.md) e [LICENSE](../../LICENSE)) e os manuais técnicos especializados presentes na pasta [/docs](./) ([DEVELOPMENT_WORKFLOW.md](../architecture/DEVELOPMENT_WORKFLOW.md), [ARCHITECTURE.md](../architecture/ARCHITECTURE.md), [RELEASE_PROCESS.md](../releases/RELEASE_PROCESS.md), [AGENTS.md](../governance/AGENTS.md), [DECISIONS.md](../architecture/DECISIONS.md) e relatórios consolidantes).
...
*   **Sobreposições Aceitáveis:** O [README.md](../../README.md) e o [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) citam os provedores de IA suportados (Gemini, OpenAI, Groq, Puter) e a estrutura física de arquivos, mas de perspectivas totalmente distintas:
...
*   **Ação:** Inclusão de uma seção "Guia de Onboarding e Banco Local" no arquivo [DEVELOPMENT_WORKFLOW.md](../architecture/DEVELOPMENT_WORKFLOW.md), orientando o uso do arquivo `backup.sql` e a configuração padrão das tabelas WordPress locais com prefixo `wpgj_`.

### 3. Prioridade Baixa (Impacto na Robustez Operacional)
*   **Ação:** Inclusão de uma subseção de "Troubleshooting de Integrações" no arquivo [ARCHITECTURE.md](../architecture/ARCHITECTURE.md), fornecendo dicas sobre bypass de popups de segurança do Puter.js e boas práticas de rotação de credenciais de chaves de API locais para evitar vazamentos acidentais.
