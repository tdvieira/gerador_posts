...
*   **Separação Conceitual**: O manual [docs/AGENTS.md](../governance/AGENTS.md) permanece classificado como documentação voltada exclusivamente para programadores humanos. O bootstrap o referencia unicamente como material técnico complementar de apoio no rodapé, sem sobreposição de responsabilidades.
