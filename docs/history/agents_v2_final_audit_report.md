...
* **Fase 5: Integração e Validação do Ecossistema**
  ...
  * *Entregáveis:* Saneamento de referências cruzadas e recálculo de caminhos relativos em [MAINTENANCE_GUIDE.md](../architecture/MAINTENANCE_GUIDE.md) e [TROUBLESHOOTING.md](../architecture/TROUBLESHOOTING.md).
...
* [README.md](../../README.md): Documento conceitual de entrada do ecossistema v2.
