# Regras do Domínio de Prompts (Regras do Domínio de Prompts)
...
*   **Responsabilidade de Prompts:** Prompts operacionais funcionam exclusivamente como modelos de suporte sistêmicos e modelos de instrução temporária. É terminantemente proibido inserir regras normativas permanentes de desenvolvimento de código ou Git dentro de arquivos de prompts.
